...
// ============================================================
// 兼容性：保留旧的 AssetType 枚举（11种类型）
// ============================================================

/// 旧版资产类型枚举（包含负债类型，用于向后兼容）
#[deprecated(note = "请使用 AssetType 或 LiabilityType")]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
pub enum LegacyAssetType {
    #[serde(rename = "property")]
    Property,       // 房产
    #[serde(rename = "deposit")]
    Deposit,        // 存款
...
impl LegacyAssetType {
    pub fn from_str(s: &str) -> Option<Self> {
        match s {
            "property" => Some(LegacyAssetType::Property),
            "deposit" => Some(LegacyAssetType::Deposit),
            "stock" => Some(LegacyAssetType::Stock),
            "fund" => Some(LegacyAssetType::Fund),
            "insurance" => Some(LegacyAssetType::Insurance),
            "debt" => Some(LegacyAssetType::Debt),
            "mortgage" => Some(LegacyAssetType::Mortgage),
            "car_loan" => Some(LegacyAssetType::CarLoan),
            "credit_card" => Some(LegacyAssetType::CreditCard),
            "personal_loan" => Some(LegacyAssetType::PersonalLoan),
            "private_loan" => Some(LegacyAssetType::PrivateLoan),
            _ => None,
        }
    }
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            LegacyAssetType::Property => "property",
            LegacyAssetType::Deposit => "deposit",
            LegacyAssetType::Stock => "stock",
            LegacyAssetType::Fund => "fund",
            LegacyAssetType::Insurance => "insurance",
            LegacyAssetType::Debt => "debt",
            LegacyAssetType::Mortgage => "mortgage",
            LegacyAssetType::CarLoan => "car_loan",
            LegacyAssetType::CreditCard => "credit_card",
            LegacyAssetType::PersonalLoan => "personal_loan",
            LegacyAssetType::PrivateLoan => "private_loan",
        }
    }
    ...
    pub fn is_liability(&self) -> bool {
        matches!(self,
            LegacyAssetType::Debt |
            LegacyAssetType::Mortgage |
            LegacyAssetType::CarLoan |
            LegacyAssetType::CreditCard |
            LegacyAssetType::PersonalLoan |
            LegacyAssetType::PrivateLoan
        )
    }
}
