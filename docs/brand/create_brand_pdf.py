...
c.drawCentredString(width/2, title_y - 42*mm, 'ASSET')

c.setFillColorRGB(0.4, 0.4, 0.4)
c.setFont('Helvetica', 12)
c.drawCentredString(width/2, title_y - 65*mm, 'Brand Design System')

c.setFillColor(EMERALD_GREEN)
c.setFont('Helvetica-Oblique', 11)
c.drawCentredString(width/2, title_y - 85*mm, 'Family Wealth. Secure Control.')
...
c.drawCentredString(width/2, 35*mm, 'LOCALFAMILY ASSET 2025')
...
c.save()
print('Multi-page brand design PDF created: LocalFamily_Asset_Brand_Design.pdf')
